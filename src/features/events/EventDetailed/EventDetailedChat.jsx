...
class EventDetailedChat extends Component {
  state = {
    showReplyForm: false,
    selecteddCommentId: null
  };

  handleOpenReplyForm = id => () => {
    this.setState({
      showReplyForm: true,
      selecteddCommentId: id
    });
  };
  ...
  render() {
    ...
    const { showReplyForm, selecteddCommentId } = this.state;
                ...
                <Comment key={comment.id}>
                  ...
                  <Comment.Content>
                    ...
                    <Comment.Actions>
                      ...
                      {showReplyForm && selecteddCommentId === comment.id && (
